...
public class SearchTest extends TestBase {
    ...
    public void searchVodafone_TestCase() throws IOException, ParseException {
        ...
        // Step 4 Count SearchTest result in page 2 and scroll down to click on the next link to navigate to page 3
        ...
        // Step 5 Count SearchTest results in page 3 and compare with the  count of SearchTest  results in page 2
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
